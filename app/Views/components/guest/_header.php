            ...
            <div class="row">
                <div class="col-lg-8 col-12 d-flex flex-wrap">
                    <p class="d-flex me-4 mb-0">
                        ...
                        Kp. Sempu, Pasirgombong, Kec. Cikarang Utara, Kab. Bekasi
                    </p>

                    <p class="d-flex mb-0">
                        <i class="bi-envelope me-2"></i>
                        <a href="mailto:sdn_pasirgombong02@yahoo.com">
                            sdn_pasirgombong02@yahoo.com
                        </a>
                    </p>
                </div>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?= base_url() ?>#section_2">Visi Misi</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link" href="#section_3">Causes</a>
                    </li>
